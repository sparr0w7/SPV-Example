...
public class DashTestNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public DashTestNetParams() {
        super();
        interval = INTERVAL;
    ...
    private static DashTestNetParams instance;
    public static synchronized DashTestNetParams get() {
        if (instance == null) {
            instance = new DashTestNetParams();
        }
        return instance;
    }
