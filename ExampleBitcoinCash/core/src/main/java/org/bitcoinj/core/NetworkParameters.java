...
import org.bitcoinj.params.CashMainNetParams;
import org.bitcoinj.params.CashTestNetParams;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_CASH_MAINNET = "org.bitcoinj.cash_mainnet";
    /** The string returned by getId() for the Qtum mainnet. */
    public static final String ID_CASH_TESTNET = "org.bitcoinj.cash_testnet";
    ...
    /** The string returned by getId() for the Lite mainnet. */
    public static final String ID_LITE_MAINNET = "org.bitcoinj.lite_mainnet";

    /** The string returned by getId() for the Lite mainnet. */
    public static final String ID_LITE_TESTNET = "org.bitcoinj.lite_testnet";

    /** The string returned by getId() for the ID_DASH_MAINNET. */
    public static final String ID_DASH_MAINNET = "org.bitcoinj.dash_mainnet";

    /** The string returned by getId() for the ID_DASH_TESTNET. */
    public static final String ID_DASH_TESTNET = "org.bitcoinj.dash_testnet";
    ...
    protected Coin dustSoftLimit; //LiteCoin
    protected Boolean fixTimeWarpBug; //LiteCoin
    ...
    /** Alias for QtumMainNet, use that instead. */
    @Deprecated
    public static NetworkParameters cashMainNet() {
        return CashMainNetParams.get();
    }

    /** Alias for QtumTestNet.get(), use that instead. */
    @Deprecated
    public static NetworkParameters cashTestNet() {
        return CashTestNetParams.get();
    }

    /** Alias for QtumMainNet, use that instead. */
    @Deprecated
    public static NetworkParameters qtumMainNet() {
        return QtumMainNetParams.get();
    }

    /** Alias for QtumTestNet.get(), use that instead. */
    @Deprecated
    public static NetworkParameters qtumTestNet() {
        return QtumTestNetParams.get();
    }

    /** Alias for QtumTestNet.get(), use that instead. */
    @Deprecated
    public static NetworkParameters liteMainNet() {
        return LitecoinNetParameters.get();
    }

    /** Alias for QtumTestNet.get(), use that instead. */
    @Deprecated
    public static NetworkParameters liteTestNet() {
        return LitecoinTestNetParameters.get();
    }

    /** Alias for QtumTestNet.get(), use that instead. */
    @Deprecated
    public static NetworkParameters dashMainNet() {
        return DashMainNetParams.get();
    }

    /** Alias for QtumTestNet.get(), use that instead. */
    @Deprecated
    public static NetworkParameters dashTestNet() {
        return DashTestNetParams.get();
    }
    ...
    public static NetworkParameters fromID(String id) {
        if (id.equals(ID_MAINNET)) {
            ...
            return UnitTestParams.get();
        } else if (id.equals(ID_CASH_MAINNET)) {
            return UnitTestParams.get();
        } else if (id.equals(ID_CASH_TESTNET)) {
            return UnitTestParams.get();
        } else if (id.equals(ID_QTUM_MAINNET)) {
            return UnitTestParams.get();
        } else if (id.equals(ID_QTUM_TESTNET)) {
            return UnitTestParams.get();
        }else if (id.equals(ID_LITE_MAINNET)) {
            return LitecoinNetParameters.get();
        }else if (id.equals(ID_LITE_TESTNET)) {
            return LitecoinTestNetParameters.get();
        } else if (id.equals(ID_DASH_MAINNET)) {
            return DashMainNetParams.get();
        }else if (id.equals(ID_DASH_TESTNET)) {
            return DashTestNetParams.get();
        }
